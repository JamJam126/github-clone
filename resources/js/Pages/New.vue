        ...
        <div class="flex flex-col justify-center items-center ">
            ...
            <form @submit.prevent="createRepository">
                ...
                <div>
                    ...
                    <select class="text-black" id="visibility" v-model="form.visibility" required>
                        <option value="public">Public</option>
                        <option value="private">Private</option>
                    </select>
                    <div v-if="form.errors.visibility" class="error">{{ form.errors.visibility }}</div>
                </div>
                <button type="submit" :disabled="form.processing">Create Repository</button>
            </form>
